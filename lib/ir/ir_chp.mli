...
type t =
  | Nop
  | Assign of Code_pos.t * (Ir_var.t * sexper) * Ir_expr.U.t
  ...
  | Read of Code_pos.t * Ir_chan.t * (Ir_var.t * sexper)
  | Send of Code_pos.t * (Ir_chan.t * sexper) * Ir_expr.U.t
  ...
  | ReadUGMem of Code_pos.t * Ir_mem.t * Cint0.t Ir_expr.t * (Ir_var.t * sexper)
  | WriteUGMem of
      Code_pos.t * (Ir_mem.t * sexper) * Cint0.t Ir_expr.t * Ir_expr.U.t
