...
let%expect_test "fibonacci" =
  ...
  [%expect
    ...
    dataflow {
      ...
      v646 <- ( log2_one_hot({ int((v41), 1), int((v40), 1), int((v39), 1), int((v38), 1), int((v37), 1), int((v36), 1), int((v35), 1), int((v34), 1), int((v33), 1), int((v32), 1), int((v31), 1), int((v30), 1), int((v29), 1), int((v28), 1), int((v27), 1), int((v26), 1) }) );
      dataflow_cluser {
        v59 <- int((v58) >= 1);
        v60 <- int(int((v58) >= 1) = 0);
        v98 <- int((v58) >= 2);
      ...
      dataflow_cluser {
        ...
        v647 <- ( log2_one_hot({ int((v60), 1), int((v59), 1) }) );
      };
      v70 <- (1 ^ (v69));
      v73 <- (1 ^ (v72));
      v618 <- ( log2_one_hot((v78)) );
      v619 <- ( log2_one_hot((v84)) );
      v620 <- ( log2_one_hot((v89)) );
      v621 <- ( log2_one_hot((v95)) );
      dataflow_cluser {
        v121 <- { int((v99), 1), int((v98), 1) };
        v132 <- { int((v99), 1), int((v98), 1) };
        v648 <- ( log2_one_hot({ int((v99), 1), int((v98), 1) }) );
      };
      v105 <- ((v101) + 1);
      v109 <- ((v105) << 1);
      v111 <- (1 ^ (v110));
      v114 <- (1 ^ (v113));
      v622 <- ( log2_one_hot((v119)) );
      v623 <- ( log2_one_hot((v125)) );
      v624 <- ( log2_one_hot((v130)) );
      v625 <- ( log2_one_hot((v136)) );
      dataflow_cluser {
        v162 <- { int((v140), 1), int((v139), 1) };
        v173 <- { int((v140), 1), int((v139), 1) };
        v649 <- ( log2_one_hot({ int((v140), 1), int((v139), 1) }) );
      };
      v146 <- ((v142) + 1);
      v150 <- ((v146) << 1);
      v152 <- (1 ^ (v151));
      v155 <- (1 ^ (v154));
      v626 <- ( log2_one_hot((v160)) );
      v627 <- ( log2_one_hot((v166)) );
      v628 <- ( log2_one_hot((v171)) );
      v629 <- ( log2_one_hot((v177)) );
      v650 <- ( log2_one_hot({ int((v195), 1), int((v194), 1), int((v193), 1), int((v192), 1), int((v191), 1), int((v190), 1), int((v189), 1), int((v188), 1), int((v187), 1), int((v186), 1), int((v185), 1), int((v184), 1), int((v183), 1), int((v182), 1), int((v181), 1), int((v180), 1) }) );
      dataflow_cluser {
        v379 <- int((v212) >= 1);
      ...
      dataflow_cluser {
        ...
        v651 <- ( log2_one_hot({ int((v228), 1), int((v227), 1), int((v226), 1), int((v225), 1), int((v224), 1), int((v223), 1), int((v222), 1), int((v221), 1), int((v220), 1), int((v219), 1), int((v218), 1), int((v217), 1), int((v216), 1), int((v215), 1), int((v214), 1), int((v213), 1) }) );
      };
      ...
      v309 <- (1 ^ (v308));
      v312 <- (1 ^ (v311));
      v630 <- ( log2_one_hot((v317)) );
      v631 <- ( log2_one_hot((v337)) );
      v632 <- ( log2_one_hot((v342)) );
      v633 <- ( log2_one_hot((v362)) );
      dataflow_cluser {
        v400 <- { int((v380), 1), int((v379), 1) };
        v413 <- { int((v380), 1), int((v379), 1) };
        v652 <- ( log2_one_hot({ int((v380), 1), int((v379), 1) }) );
      };
      dataflow_cluser {
      ...
      v390 <- (1 ^ (v389));
      v393 <- (1 ^ (v392));
      v634 <- ( log2_one_hot((v398)) );
      v635 <- ( log2_one_hot((v404)) );
      v636 <- ( log2_one_hot((v411)) );
      v637 <- ( log2_one_hot((v417)) );
      dataflow_cluser {
        v441 <- { int((v421), 1), int((v420), 1) };
        v454 <- { int((v421), 1), int((v420), 1) };
        v653 <- ( log2_one_hot({ int((v421), 1), int((v420), 1) }) );
      };
      dataflow_cluser {
      ...
      v431 <- (1 ^ (v430));
      v434 <- (1 ^ (v433));
      v638 <- ( log2_one_hot((v439)) );
      v639 <- ( log2_one_hot((v445)) );
      v640 <- ( log2_one_hot((v452)) );
      v641 <- ( log2_one_hot((v458)) );
      dataflow_cluser {
        v481 <- { int((v462), 1), int((v461), 1) };
        v494 <- { int((v462), 1), int((v461), 1) };
        v654 <- ( log2_one_hot({ int((v462), 1), int((v461), 1) }) );
      };
      dataflow_cluser {
      ...
      v471 <- (1 ^ (v470));
      v474 <- (1 ^ (v473));
      v642 <- ( log2_one_hot((v479)) );
      v643 <- ( log2_one_hot((v485)) );
      v644 <- ( log2_one_hot((v492)) );
      v645 <- ( log2_one_hot((v498)) );
      v505 <- ((v503) | (v504));
      v509 <- ((v507) ^ 1);
      v514 <- ((v512) | (v513));
      v518 <- ((v516) ^ 1);
      ...
      { v628 } v151, v176 -> v174;
      { v629 } v150, v179 -> v167;
      { v630 } v321, v322, v323, v324, v325, v326, v327, v328, v329, v330, v331, v332, v333, v311, v335, v336 -> v320;
      { v631 } v313 -> *, *, *, *, *, *, *, *, *, *, *, *, *, v310, *, *;
      { v632 } v346, v347, v348, v349, v350, v351, v352, v353, v354, v355, v356, v357, v308, v359, v360, v361 -> v345;
      { v633 } v363, v364, v365, v366, v367, v368, v369, v370, v371, v372, v373, v374, v251, v376, v377, v378 -> v338;
      { v634 } v392, v403 -> v401;
      { v635 } v381, v406 -> v394;
      { v636 } v389, v416 -> v414;
      { v637 } v388, v419 -> v407;
      ...
      { v576 } v581, v580 -> v578;
      { v580 } v555, v488 -> v573;
      { v646 } v42, v43, v44, v45, v46, v47, v48, v49, v50, v51, v52, v53, v54, v55, v56, v57 -> v58;
      { v647 } v8 -> *, v62;
      { v647 } v71, v582 -> v64;
      { v647 } v65, v62 -> v66;
      { v648 } v66 -> v101, v102;
      ...
      { v649 } v153, v584 -> v145;
      { v649 } v146, v143 -> v147;
      { v650 } v196, v197, v198, v199, v200, v201, v202, v203, v204, v205, v206, v207, v208, v209, v210, v211 -> v212;
      { v651 } v6 -> *, v229, v230, v231, v232, v233, v234, v235, v236, v237, v238, v239, v240, v241, v242, v243;
      { v651 } v64 -> *, *, *, v244, v245, v246, v247, *, *, v248, v249, v250, v251, *, v252, v253;
      { v651 } v104 -> *, *, *, *, *, v254, v255, *, *, v256, v257, v258, *, *, *, v259;
      { v651 } v145 -> *, *, *, *, *, *, v260, *, *, *, *, *, *, *, *, *;
      { v651 } v25 -> *, *, v294, v295, *, *, *, *, *, *, *, *, *, *, *, *;
      { v651 } v296, v229, v230, v231, v232, v233, v234, v235, v236, v237, v238, v239, v240, v241, v242, v243 -> v3;
      { v651 } v585, v586, v294, v297, v245, v246, v247, v587, v588, v298, v299, v300, v589, v310, v302, v303 -> v304;
      { v651 } v590, v591, v592, v593, v245, v254, v260, v594, v595, v596, v597, v598, v599, v600, v601, v602 -> v305;
      { v651 } v603, v604, v605, v606, v607, v608, v255, v609, v610, v611, v612, v613, v614, v615, v616, v617 -> v306;
      { v652 } v304 -> v381, *;
      { v652 } v147 -> v382, v383;
      { v652 } v384, v383 -> v385;
      { v653 } v305 -> v422, *;
