...
let%expect_test "fibonacci" =
  ...
  [%expect
    ...
    dataflow {
     ...
     v25 -> [1,0] v26;
      v26 <- (1 ^ (v25));
      v27 <- (((((((((((((((int(0 = (v19)) << 0) | (int(1 = (v19)) << 1)) | (int(2 = (v19)) << 2)) | (int(3 = (v19)) << 3)) | (int(4 = (v19)) << 4)) | (int(5 = (v19)) << 5)) | (int(6 = (v19)) << 6)) | (int(7 = (v19)) << 7)) | (int(8 = (v19)) << 8)) | (int(9 = (v19)) << 9)) | (int(10 = (v19)) << 10)) | (int(11 = (v19)) << 11)) | (int(12 = (v19)) << 12)) | (int(13 = (v19)) << 13)) | (int(14 = (v19)) << 14));
     ...
     v445 -> [1,0] v448;
      ...
      {v459} v434, v109 -> v452;
     v454 -> [1,0] v457;
      v419 <- ((int(0 = int((v19) = 0)) << 0) | (int(1 = int((v19) = 0)) << 1));
      {v419} v48 -> v420, *;
      {v419} v19 -> *, v421;
      {v419} v19 -> *, v422;
      {v419} v423, v424 -> v78;
     ...
     v580 -> [1,0] v581;
      v581 <- (1 ^ (v580));
      v19 <- int(((int((v19), 8) | 256) + int((v19), 8)), 8);
     v582 -> [1,0] v583;
      v583 <- (1 ^ (v582));
      {v604} v594, v580 -> v605;
      v606 <- ((v604) | (v605));
     ...
     v697 -> [1,0] v700;
      ...
      {v706} v707 -> v*, vv709;
      {v706} v27, v709 -> v708;
      {v708} v711, v712, v105, v714, v715, v716, v717, v718, v719, v720, v721, v722, v723, v724, v725 -> v705;
      v711 <- 0;
      v712 <- 0;
      v714 <- 0;
      v715 <- 0;
     ...
     v707 -> [1,1] v708;
      {v729} v730 -> v*, vv732;
      {v729} v27, v732 -> v731;
      {v731} v734, v735, v736, v122, v194, v301, v379, v444, v485, v535, v585, v616, v746, v637, v678 -> v728;
      v734 <- 0;
      v735 <- 0;
      v736 <- 0;
      v746 <- 0;
      {v728} v731 -> v*, vv749;
      {v749} v727 -> *, *, *, v19, v193, v300, v378, v443, v484, v534, v584, v19, *, v19, v677;
     v729 -> [1,0] v728;
     v730 -> [1,1] v731;
      {v752} v753 -> v*, vv755;
      {v752} v27, v755 -> v754;
      {v754} v757, v758, v759, v760, v761, v762, v763, v764, v765, v766, v767, v768, v622, v770, v771 -> v751;
      v757 <- 0;
      v758 <- 0;
      v759 <- 0;
      v760 <- 0;
     ...
     v753 -> [1,1] v754;
      {v775} v776 -> v*, vv778;
      {v775} v27, v778 -> v777;
      {v777} v780, v781, v103, v783, v784, v785, v786, v787, v788, v789, v790, v791, v792, v793, v794 -> v774;
      v780 <- 0;
      v781 <- 0;
      v783 <- 0;
      v784 <- 0;
      ...
      v794 <- 0;
      {v774} v777 -> v*, vv795;
      {v795} v796, v797, v21, v799, v800, v801, v802, v803, v804, v805, v806, v807, v808, v809, v810 -> v773;
      v796 <- 0;
      v797 <- 0;
      v799 <- 0;
      v800 <- 0;
     ...
     v776 -> [1,1] v777;
      {v813} v814 -> v*, vv816;
      {v813} v27, v816 -> v815;
      {v815} v818, v819, v113, v147, v221, v346, v824, v825, v482, v532, v582, v829, v629, v643, v675 -> v812;
      v818 <- 0;
      v819 <- 0;
      v824 <- 0;
      v825 <- 0;
      v829 <- 0;
      {v812} v815 -> v*, vv833;
      {v833} v834, v835, v19, v146, v220, v345, v840, v841, v19, v19, v19, v845, v19, v19, v19 -> v811;
      v834 <- 0;
      v835 <- 0;
      v840 <- 0;
      v841 <- 0;
     ...
     v814 -> [1,1] v815;
      {v851} v852 -> v*, vv854;
      {v851} v27, v854 -> v853;
      {v853} v856, v857, v110, v156, v230, v355, v388, v453, v503, v553, v603, v614, v627, v646, v696 -> v850;
      v856 <- 0;
      v857 <- 0;
      {v850} v853 -> v*, vv871;
      {v871} v872, v873, v109, v155, v229, v354, v387, v452, v502, v552, v602, v109, v109, v645, v695 -> v849;
      v872 <- 0;
      v873 <- 0;
     v851 -> [1,0] v850;
     v852 -> [1,1] v853;
      {v889} v890 -> v*, vv892;
      {v889} v27, v892 -> v891;
      {v891} v894, v895, v896, v897, v898, v899, v900, v901, v902, v903, v904, v619, v906, v907, v908 -> v888;
      v894 <- 0;
      v895 <- 0;
      v896 <- 0;
      v897 <- 0;
      ...
      v908 <- 0;
      {v888} v891 -> v*, vv909;
      {v909} v910, v911, v912, v913, v914, v915, v916, v917, v918, v919, v920, v19, v922, v923, v924 -> v887;
      v910 <- 0;
      v911 <- 0;
      v912 <- 0;
      v913 <- 0;
