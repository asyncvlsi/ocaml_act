...
let%expect_test "fibonacci" =
  ...
  [%expect
    ...
    defproc proc_0(chan!(int<8>) iport1235; chan!(int<8>) iport1236; chan!(int<8>) iport1237; chan?(int<13>) oport38; chan?(int<8>) oport891; chan?(int<13>) oport907; chan?(int<8>) oport529) {
      chan(int<8>) v0;
      chan(int<8>) v1;
      chan(int<8>) v2;
      chan(int<8>) v3;
    ...
    dataflow {
      ...
      v210 <- ( log2_one_hot({ int((v161), 1), int((v160), 1), int((v159), 1), int((v158), 1), int((v157), 1), int((v156), 1), int((v155), 1), int((v154), 1), int((v153), 1), int((v152), 1), int((v151), 1), int((v150), 1), int((v149), 1), int((v148), 1), int((v147), 1), int((v146), 1) }) );
      dataflow_cluser {
        v212 <- int((v911) >= 1);
        v213 <- int(int((v911) >= 1) = 0);
        v214 <- int((v911) >= 2);
        v215 <- int(int((v911) >= 2) = 0);
        v216 <- int((v911) >= 3);
        v217 <- int(int((v911) >= 3) = 0);
      };
      dataflow_cluser {
        v220 <- { int((v213), 1), int((v212), 1) };
        v221 <- { int((v213), 1), int((v212), 1) };
        v222 <- ( log2_one_hot({ int((v213), 1), int((v212), 1) }) );
      };
      v224 <- (1 ^ (v223));
      v226 <- (1 ^ (v225));
      v228 <- ( log2_one_hot((v227)) );
      v230 <- ( log2_one_hot((v616)) );
      v232 <- ( log2_one_hot((v231)) );
      v234 <- ( log2_one_hot((v626)) );
      dataflow_cluser {
        v237 <- { int((v215), 1), int((v214), 1) };
        v238 <- { int((v215), 1), int((v214), 1) };
        v239 <- ( log2_one_hot({ int((v215), 1), int((v214), 1) }) );
      };
      v241 <- ((v940) + 1);
      v243 <- ((v242) << 1);
      v245 <- (1 ^ (v244));
      v247 <- (1 ^ (v246));
      v249 <- ( log2_one_hot((v248)) );
      v251 <- ( log2_one_hot((v636)) );
      v253 <- ( log2_one_hot((v252)) );
      v255 <- ( log2_one_hot((v646)) );
      dataflow_cluser {
        v258 <- { int((v217), 1), int((v216), 1) };
        v259 <- { int((v217), 1), int((v216), 1) };
        v260 <- ( log2_one_hot({ int((v217), 1), int((v216), 1) }) );
      };
      v262 <- ((v952) + 1);
      v264 <- ((v263) << 1);
      v266 <- (1 ^ (v265));
      v268 <- (1 ^ (v267));
      v270 <- ( log2_one_hot((v269)) );
      v272 <- ( log2_one_hot((v656)) );
      v274 <- ( log2_one_hot((v273)) );
      v276 <- ( log2_one_hot((v666)) );
      v293 <- ( log2_one_hot({ int((v177), 1), int((v176), 1), int((v175), 1), int((v174), 1), int((v173), 1), int((v172), 1), int((v171), 1), int((v170), 1), int((v169), 1), int((v168), 1), int((v167), 1), int((v166), 1), int((v165), 1), int((v164), 1), int((v163), 1), int((v162), 1) }) );
      dataflow_cluser {
        v295 <- int((v964) >= 1);
        v296 <- int(int((v964) >= 1) = 0);
        v297 <- int((v964) >= 2);
        v298 <- int(int((v964) >= 2) = 0);
        v299 <- int((v964) >= 3);
        v300 <- int(int((v964) >= 3) = 0);
      };
      dataflow_cluser {
        v317 <- { int((v193), 1), int((v192), 1), int((v191), 1), int((v190), 1), int((v189), 1), int((v188), 1), int((v187), 1), int((v186), 1), int((v185), 1), int((v184), 1), int((v183), 1), int((v182), 1), int((v181), 1), int((v180), 1), int((v179), 1), int((v178), 1) };
        v318 <- { int((v193), 1), int((v192), 1), int((v191), 1), int((v190), 1), int((v189), 1), int((v188), 1), int((v187), 1), int((v186), 1), int((v185), 1), int((v184), 1), int((v183), 1), int((v182), 1), int((v181), 1), int((v180), 1), int((v179), 1), int((v178), 1) };
        v319 <- ( log2_one_hot({ int((v193), 1), int((v192), 1), int((v191), 1), int((v190), 1), int((v189), 1), int((v188), 1), int((v187), 1), int((v186), 1), int((v185), 1), int((v184), 1), int((v183), 1), int((v182), 1), int((v181), 1), int((v180), 1), int((v179), 1), int((v178), 1) }) );
      };
      v322 <- ((v1023) | int((int((v999), 4) << 4), 8));
      v325 <- int((v1003) = (v1013));
      v328 <- int(((v1004) + (v1014)), 8);
      v331 <- int(((int((v1015), 8) | 256) + int((v1005), 8)), 8);
      v333 <- int(0 = (v1007));
      v336 <- (int(0 != (v1008)) | int(0 != (v1016)));
      v338 <- (1 ^ (v337));
      v340 <- (1 ^ (v339));
      v342 <- ( log2_one_hot((v341)) );
      v344 <- ( log2_one_hot((v676)) );
      v346 <- ( log2_one_hot((v345)) );
      v348 <- ( log2_one_hot((v686)) );
      dataflow_cluser {
        v351 <- { int((v296), 1), int((v295), 1) };
        v352 <- { int((v296), 1), int((v295), 1) };
        v353 <- ( log2_one_hot({ int((v296), 1), int((v295), 1) }) );
      };
      dataflow_cluser {
        v355 <- { int((v1101), 12), int(1, 1) };
        v356 <- (1 + (v1101));
      };
      v358 <- (1 ^ (v357));
      v360 <- (1 ^ (v359));
      v362 <- ( log2_one_hot((v361)) );
      v364 <- ( log2_one_hot((v696)) );
      v366 <- ( log2_one_hot((v365)) );
      v368 <- ( log2_one_hot((v706)) );
      dataflow_cluser {
        v371 <- { int((v298), 1), int((v297), 1) };
        v372 <- { int((v298), 1), int((v297), 1) };
        v373 <- ( log2_one_hot({ int((v298), 1), int((v297), 1) }) );
      };
      dataflow_cluser {
        v375 <- { int((v1112), 12), int(1, 1) };
        v376 <- (1 + (v1112));
      };
      v378 <- (1 ^ (v377));
      v380 <- (1 ^ (v379));
      v382 <- ( log2_one_hot((v381)) );
      v384 <- ( log2_one_hot((v716)) );
      v386 <- ( log2_one_hot((v385)) );
      v388 <- ( log2_one_hot((v726)) );
      dataflow_cluser {
        v391 <- { int((v300), 1), int((v299), 1) };
        v392 <- { int((v300), 1), int((v299), 1) };
        v393 <- ( log2_one_hot({ int((v300), 1), int((v299), 1) }) );
      };
      dataflow_cluser {
        v395 <- { int((v1123), 12), int(1, 1) };
        v396 <- (1 + (v1123));
      };
      v398 <- (1 ^ (v397));
      v400 <- (1 ^ (v399));
      v402 <- ( log2_one_hot((v401)) );
      v404 <- ( log2_one_hot((v736)) );
      v406 <- ( log2_one_hot((v405)) );
      v408 <- ( log2_one_hot((v746)) );
      v411 <- ((v409) | (v410));
      v413 <- ((v753) ^ 1);
      v416 <- ((v414) | (v415));
      v418 <- ((v772) ^ 1);
      ...
      { v274 } v483, v64 -> v482;
      { v276 } v264, v65 -> v486;
      { v342 } v83, v84, v85, v86, v87, v88, v89, v90, v91, v92, v93, v94, v95, v504, v96, v97 -> v490;
      { v344 } v1237 -> *, *, *, *, *, *, *, *, *, *, *, *, *, v508, *, *;
      { v346 } v98, v99, v100, v101, v102, v103, v104, v105, v106, v107, v108, v109, v524, v110, v111, v112 -> v511;
      { v348 } v113, v114, v115, v116, v117, v118, v119, v120, v121, v122, v123, v124, v1006, v125, v126, v127 -> v529;
      { v362 } v548, v128 -> v547;
      { v364 } v1098, v129 -> v551;
      { v366 } v556, v130 -> v555;
      { v368 } v355, v131 -> v559;
      { v382 } v564, v132 -> v563;
      { v384 } v1109, v133 -> v567;
      { v386 } v572, v134 -> v571;
      { v388 } v375, v135 -> v575;
      { v402 } v580, v136 -> v579;
      { v404 } v1120, v137 -> v583;
      { v406 } v588, v138 -> v587;
      { v408 } v395, v139 -> v591;
      { v597 } v596 -> *, v595;
      { v600 } v1127 -> *, v598;
      ...
      { v906 } v444, v905 -> v903;
      { v910 } v875, v591 -> v907;
      { v210 } v39, v40, v41, v42, v43, v44, v45, v46, v47, v48, v49, v50, v51, v52, v53, v54 -> v911;
      { v931 } v605 -> *, v929;
      { v935 } v449, v0 -> v932;
      { v939 } v55, v929 -> v936;
      { v943 } v936 -> v940, v941;
      ...
      { v959 } v479, v2 -> v956;
      { v963 } v961, v953 -> v960;
      { v293 } v66, v67, v68, v69, v70, v71, v72, v73, v74, v75, v76, v77, v78, v79, v80, v81 -> v964;
      { v998 } v601 -> *, v982, v983, v984, v985, v986, v987, v988, v989, v990, v991, v992, v993, v994, v995, v996;
      { v1010 } v932 -> *, *, *, v999, v1000, v1001, v1002, *, *, v1003, v1004, v1005, v1006, *, v1007, v1008;
      { v1018 } v944 -> *, *, *, *, *, v1011, v1012, *, *, v1013, v1014, v1015, *, *, *, v1016;
      { v1021 } v956 -> *, *, *, *, *, *, v1019, *, *, *, *, *, *, *, *, *;
      { v1025 } v144 -> *, *, v1022, v1023, *, *, *, *, *, *, *, *, *, *, *, *;
      { v1043 } v82, v982, v983, v984, v985, v986, v987, v988, v989, v990, v991, v992, v993, v994, v995, v996 -> v1026;
      { v1061 } v3, v4, v1022, v322, v1049, v1001, v1002, v5, v6, v325, v328, v331, v7, v508, v333, v336 -> v1044;
      { v1079 } v8, v9, v10, v11, v1067, v1011, v1019, v12, v13, v14, v15, v16, v17, v18, v19, v20 -> v1062;
      { v1097 } v21, v22, v23, v24, v25, v26, v1012, v27, v28, v29, v30, v31, v32, v33, v34, v35 -> v1080;
      { v1100 } v1044 -> v1098, *;
      { v1104 } v960 -> v1101, v1102;
      { v1108 } v356, v1102 -> v1105;
      { v1111 } v1062 -> v1109, *;
      { v1115 } v1105 -> v1112, v1113;
      { v1119 } v376, v1113 -> v1116;
      { v1122 } v1080 -> v1120, *;
      { v1126 } v1116 -> v1123, v1124;
      { v1130 } v396, v1124 -> v1127;
      v1131 -> [1,0] v1132;
      v224 -> [1,0] v1134;
      v226 -> [1,0] v1136;
      v1137 -> [1,0] v1138;
      ...
      v887 -> [1,0] v1232;
      v903 -> [1,0] v1234;
      v1131 <- v141;     v600 <- v141;     v597 <- v141;
      v939 <- v222;     v935 <- v222;     v931 <- v222;
      v951 <- v239;     v947 <- v239;     v943 <- v239;
      v949 <- v241;     v242 <- v241;
      v963 <- v260;     v959 <- v260;     v955 <- v260;
      v961 <- v262;     v263 <- v262;
      v1097 <- v319;     v1079 <- v319;     v1061 <- v319;     v1043 <- v319;     v1025 <- v319;     v1021 <- v319;     v1018 <- v319;     v1010 <- v319;     v998 <- v319;
      v1108 <- v353;     v1104 <- v353;     v1100 <- v353;
      v1119 <- v373;     v1115 <- v373;     v1111 <- v373;
      v1130 <- v393;     v1126 <- v393;     v1122 <- v393;
      v1137 <- v445;     v750 <- v445;     v618 <- v445;
      v1141 <- v452;     v769 <- v452;     v628 <- v452;
      v1149 <- v460;     v751 <- v460;     v638 <- v460;
      v1153 <- v467;     v770 <- v467;     v648 <- v467;
      v1165 <- v475;     v789 <- v475;     v658 <- v475;
      v1169 <- v482;     v805 <- v482;     v668 <- v482;
      v1181 <- v490;     v678 <- v490;
      v1185 <- v511;     v688 <- v511;
      v1193 <- v547;     v842 <- v547;     v698 <- v547;
      v1197 <- v555;     v824 <- v555;     v708 <- v555;
      v1207 <- v563;     v843 <- v563;     v718 <- v563;
      v1211 <- v571;     v862 <- v571;     v728 <- v571;
      v1223 <- v579;     v881 <- v579;     v738 <- v579;
      v1227 <- v587;     v897 <- v587;     v748 <- v587;
      v1139 <- v612;     v617 <- v612;     v227 <- v612;
      v1143 <- v622;     v627 <- v622;     v231 <- v622;
      v1151 <- v632;     v637 <- v632;     v248 <- v632;
      v1155 <- v642;     v647 <- v642;     v252 <- v642;
      v1167 <- v652;     v657 <- v652;     v269 <- v652;
      v1171 <- v662;     v667 <- v662;     v273 <- v662;
      v1183 <- v672;     v677 <- v672;     v341 <- v672;
      v1187 <- v682;     v687 <- v682;     v345 <- v682;
      v1195 <- v692;     v697 <- v692;     v361 <- v692;
      v1199 <- v702;     v707 <- v702;     v365 <- v702;
      v1209 <- v712;     v717 <- v712;     v381 <- v712;
      v1213 <- v722;     v727 <- v722;     v385 <- v722;
      v1225 <- v732;     v737 <- v732;     v401 <- v732;
      v1229 <- v742;     v747 <- v742;     v405 <- v742;
      v762 <- v749;     v760 <- v749;     v756 <- v749;     v410 <- v749;
      v767 <- v754;     v759 <- v754;
      v781 <- v768;     v779 <- v768;     v775 <- v768;     v415 <- v768;
      v786 <- v773;     v778 <- v773;
      v798 <- v787;     v794 <- v787;
      v802 <- v792;     v797 <- v792;
      v816 <- v803;     v814 <- v803;     v810 <- v803;     v422 <- v803;
      v821 <- v808;     v813 <- v808;
      v835 <- v822;     v833 <- v822;     v829 <- v822;     v427 <- v822;
      v840 <- v827;     v832 <- v827;
      v854 <- v841;     v852 <- v841;     v848 <- v841;     v432 <- v841;
      v859 <- v846;     v851 <- v846;
      v873 <- v860;     v871 <- v860;     v867 <- v860;     v437 <- v860;
      v878 <- v865;     v870 <- v865;
      v890 <- v879;     v886 <- v879;
      v894 <- v884;     v889 <- v884;
      v906 <- v895;     v902 <- v895;
      v910 <- v900;     v905 <- v900;
      v1067 <- v1000;     v1049 <- v1000;
      v596 <- v1026;     v140 <- v1026;
      v608 <- v1132;     v604 <- v1132;
      v453 <- v1134;     v223 <- v1134;
      v446 <- v1136;     v225 <- v1136;
      v615 <- v1138;     v611 <- v1138;
      v625 <- v1142;     v621 <- v1142;
      v468 <- v1146;     v244 <- v1146;
      v461 <- v1148;     v246 <- v1148;
      v635 <- v1150;     v631 <- v1150;
      v645 <- v1154;     v641 <- v1154;
      v755 <- v1158;     v752 <- v1158;     v409 <- v1158;
      v774 <- v1160;     v771 <- v1160;     v414 <- v1160;
      v483 <- v1162;     v265 <- v1162;
      v476 <- v1164;     v267 <- v1164;
      v655 <- v1166;     v651 <- v1166;
      v665 <- v1170;     v661 <- v1170;
      v793 <- v1174;     v790 <- v1174;
      v809 <- v1176;     v806 <- v1176;     v421 <- v1176;
      v524 <- v1178;     v337 <- v1178;
      v504 <- v1180;     v339 <- v1180;
      v675 <- v1182;     v671 <- v1182;
      v685 <- v1186;     v681 <- v1186;
      v556 <- v1190;     v357 <- v1190;
      v548 <- v1192;     v359 <- v1192;
      v695 <- v1194;     v691 <- v1194;
      v705 <- v1198;     v701 <- v1198;
      v828 <- v1202;     v825 <- v1202;     v426 <- v1202;
      v572 <- v1204;     v377 <- v1204;
      v564 <- v1206;     v379 <- v1206;
      v715 <- v1208;     v711 <- v1208;
      v725 <- v1212;     v721 <- v1212;
      v847 <- v1216;     v844 <- v1216;     v431 <- v1216;
      v866 <- v1218;     v863 <- v1218;     v436 <- v1218;
      v588 <- v1220;     v397 <- v1220;
      v580 <- v1222;     v399 <- v1222;
      v735 <- v1224;     v731 <- v1224;
      v745 <- v1228;     v741 <- v1228;
      v885 <- v1232;     v882 <- v1232;
      v901 <- v1234;     v898 <- v1234;
    iport1235 -> v1235;
    iport1236 -> v1236;
    iport1237 -> v1237;
    v38 -> oport38;
