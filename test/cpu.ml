...
let%expect_test "fibonacci" =
  ...
  [%expect
    {|
    defproc proc_0(chan!(int<8>) iport723; chan!(int<8>) iport734; chan!(int<8>) iport745; chan?(int<13>) oport756; chan?(int<8>) oport769; chan?(int<13>) oport782; chan?(int<8>) oport795) {
      chan(int<12>) v0;
      chan(int<8>) v1;
      chan(int<8>) v2;
      chan(int<8>) v3;
    ...
    dataflow {
      ...
      dataflow_cluser {
        ...
        v87 <- int(int((v24) >= 1) = 0);
        v124 <- int((v24) >= 2);
        v125 <- int(int((v24) >= 2) = 0);
        v164 <- int((v24) >= 3);
        v165 <- int(int((v24) >= 3) = 0);
      };
      dataflow_cluser {
        v460 <- int((v38) >= 1);
        v461 <- int(int((v38) >= 1) = 0);
        v501 <- int((v38) >= 2);
        v502 <- int(int((v38) >= 2) = 0);
        v542 <- int((v38) >= 3);
        v543 <- int(int((v38) >= 3) = 0);
      };
      v52 <- (1 ^ (v51));
      dataflow_cluser {
        v56 <- int(0 = (v53));
      ...
      v55 <- (1 ^ (v54));
      v854 <- (((((((((((((((0 * (v56)) | (1 * (v57))) | (2 * (v58))) | (3 * (v59))) | (4 * (v60))) | (5 * (v61))) | (6 * (v62))) | (7 * (v63))) | (8 * (v64))) | (9 * (v65))) | (10 * (v66))) | (11 * (v67))) | (12 * (v68))) | (13 * (v69))) | (14 * (v70)));
      dataflow_cluser {
        v106 <- (((v86) << 0) | ((v87) << 1));
        v117 <- (((v86) << 0) | ((v87) << 1));
        v855 <- ((0 * (v86)) | (1 * (v87)));
      ...
      v96 <- (1 ^ (v95));
      v99 <- (1 ^ (v98));
      v807 <- ((0 * (1 & ((v104) >> 0))) | (1 * (1 & ((v104) >> 1))));
      v808 <- ((0 * (1 & ((v110) >> 0))) | (1 * (1 & ((v110) >> 1))));
      v809 <- ((0 * (1 & ((v115) >> 0))) | (1 * (1 & ((v115) >> 1))));
      v810 <- ((0 * (1 & ((v121) >> 0))) | (1 * (1 & ((v121) >> 1))));
      dataflow_cluser {
        v146 <- (((v124) << 0) | ((v125) << 1));
        v157 <- (((v124) << 0) | ((v125) << 1));
        v856 <- ((0 * (v124)) | (1 * (v125)));
      ...
      v136 <- (1 ^ (v135));
      v139 <- (1 ^ (v138));
      v811 <- ((0 * (1 & ((v144) >> 0))) | (1 * (1 & ((v144) >> 1))));
      v812 <- ((0 * (1 & ((v150) >> 0))) | (1 * (1 & ((v150) >> 1))));
      v813 <- ((0 * (1 & ((v155) >> 0))) | (1 * (1 & ((v155) >> 1))));
      v814 <- ((0 * (1 & ((v161) >> 0))) | (1 * (1 & ((v161) >> 1))));
      dataflow_cluser {
        v186 <- (((v164) << 0) | ((v165) << 1));
        v197 <- (((v164) << 0) | ((v165) << 1));
        v857 <- ((0 * (v164)) | (1 * (v165)));
      ...
      v176 <- (1 ^ (v175));
      v179 <- (1 ^ (v178));
      v815 <- ((0 * (1 & ((v184) >> 0))) | (1 * (1 & ((v184) >> 1))));
      v816 <- ((0 * (1 & ((v190) >> 0))) | (1 * (1 & ((v190) >> 1))));
      v817 <- ((0 * (1 & ((v195) >> 0))) | (1 * (1 & ((v195) >> 1))));
      v818 <- ((0 * (1 & ((v201) >> 0))) | (1 * (1 & ((v201) >> 1))));
      v858 <- (((((((((((((((0 * (v204)) | (1 * (v205))) | (2 * (v206))) | (3 * (v207))) | (4 * (v208))) | (5 * (v209))) | (6 * (v210))) | (7 * (v211))) | (8 * (v212))) | (9 * (v213))) | (10 * (v214))) | (11 * (v215))) | (12 * (v216))) | (13 * (v217))) | (14 * (v218)));
      dataflow_cluser {
        v340 <- ((((((((((((((((v234) << 0) | ((v235) << 1)) | ((v236) << 2)) | ((v237) << 3)) | ((v238) << 4)) | ((v239) << 5)) | ((v240) << 6)) | ((v241) << 7)) | ((v242) << 8)) | ((v243) << 9)) | ((v244) << 10)) | ((v245) << 11)) | ((v246) << 12)) | ((v247) << 13)) | ((v248) << 14));
        v364 <- ((((((((((((((((v234) << 0) | ((v235) << 1)) | ((v236) << 2)) | ((v237) << 3)) | ((v238) << 4)) | ((v239) << 5)) | ((v240) << 6)) | ((v241) << 7)) | ((v242) << 8)) | ((v243) << 9)) | ((v244) << 10)) | ((v245) << 11)) | ((v246) << 12)) | ((v247) << 13)) | ((v248) << 14));
        v388 <- ((((((((((((((((v234) << 0) | ((v235) << 1)) | ((v236) << 2)) | ((v237) << 3)) | ((v238) << 4)) | ((v239) << 5)) | ((v240) << 6)) | ((v241) << 7)) | ((v242) << 8)) | ((v243) << 9)) | ((v244) << 10)) | ((v245) << 11)) | ((v246) << 12)) | ((v247) << 13)) | ((v248) << 14));
        v427 <- ((((((((((((((((v234) << 0) | ((v235) << 1)) | ((v236) << 2)) | ((v237) << 3)) | ((v238) << 4)) | ((v239) << 5)) | ((v240) << 6)) | ((v241) << 7)) | ((v242) << 8)) | ((v243) << 9)) | ((v244) << 10)) | ((v245) << 11)) | ((v246) << 12)) | ((v247) << 13)) | ((v248) << 14));
        v859 <- (((((((((((((((0 * (v234)) | (1 * (v235))) | (2 * (v236))) | (3 * (v237))) | (4 * (v238))) | (5 * (v239))) | (6 * (v240))) | (7 * (v241))) | (8 * (v242))) | (9 * (v243))) | (10 * (v244))) | (11 * (v245))) | (12 * (v246))) | (13 * (v247))) | (14 * (v248)));
      };
      v313 <- int((v266) = (v274));
      v314 <- int(((v267) + (v275)), 8);
      v315 <- int(((int((v276), 8) | 256) + int((v268), 8)), 8);
      v317 <- int(0 = (v270));
      v318 <- (int(0 != (v271)) | int(0 != (v277)));
      v322 <- (1 ^ (v321));
      v325 <- (1 ^ (v324));
      v330 <- (1 ^ (v329));
      v333 <- (1 ^ (v332));
      v819 <- (((((((((((((((0 * (1 & ((v338) >> 0))) | (1 * (1 & ((v338) >> 1)))) | (2 * (1 & ((v338) >> 2)))) | (3 * (1 & ((v338) >> 3)))) | (4 * (1 & ((v338) >> 4)))) | (5 * (1 & ((v338) >> 5)))) | (6 * (1 & ((v338) >> 6)))) | (7 * (1 & ((v338) >> 7)))) | (8 * (1 & ((v338) >> 8)))) | (9 * (1 & ((v338) >> 9)))) | (10 * (1 & ((v338) >> 10)))) | (11 * (1 & ((v338) >> 11)))) | (12 * (1 & ((v338) >> 12)))) | (13 * (1 & ((v338) >> 13)))) | (14 * (1 & ((v338) >> 14))));
      v820 <- (((((((((((((((0 * (1 & ((v357) >> 0))) | (1 * (1 & ((v357) >> 1)))) | (2 * (1 & ((v357) >> 2)))) | (3 * (1 & ((v357) >> 3)))) | (4 * (1 & ((v357) >> 4)))) | (5 * (1 & ((v357) >> 5)))) | (6 * (1 & ((v357) >> 6)))) | (7 * (1 & ((v357) >> 7)))) | (8 * (1 & ((v357) >> 8)))) | (9 * (1 & ((v357) >> 9)))) | (10 * (1 & ((v357) >> 10)))) | (11 * (1 & ((v357) >> 11)))) | (12 * (1 & ((v357) >> 12)))) | (13 * (1 & ((v357) >> 13)))) | (14 * (1 & ((v357) >> 14))));
      v821 <- (((((((((((((((0 * (1 & ((v362) >> 0))) | (1 * (1 & ((v362) >> 1)))) | (2 * (1 & ((v362) >> 2)))) | (3 * (1 & ((v362) >> 3)))) | (4 * (1 & ((v362) >> 4)))) | (5 * (1 & ((v362) >> 5)))) | (6 * (1 & ((v362) >> 6)))) | (7 * (1 & ((v362) >> 7)))) | (8 * (1 & ((v362) >> 8)))) | (9 * (1 & ((v362) >> 9)))) | (10 * (1 & ((v362) >> 10)))) | (11 * (1 & ((v362) >> 11)))) | (12 * (1 & ((v362) >> 12)))) | (13 * (1 & ((v362) >> 13)))) | (14 * (1 & ((v362) >> 14))));
      v698 <- ((v365) | ((v695) ^ 1));
      v822 <- (((((((((((((((0 * (1 & ((v381) >> 0))) | (1 * (1 & ((v381) >> 1)))) | (2 * (1 & ((v381) >> 2)))) | (3 * (1 & ((v381) >> 3)))) | (4 * (1 & ((v381) >> 4)))) | (5 * (1 & ((v381) >> 5)))) | (6 * (1 & ((v381) >> 6)))) | (7 * (1 & ((v381) >> 7)))) | (8 * (1 & ((v381) >> 8)))) | (9 * (1 & ((v381) >> 9)))) | (10 * (1 & ((v381) >> 10)))) | (11 * (1 & ((v381) >> 11)))) | (12 * (1 & ((v381) >> 12)))) | (13 * (1 & ((v381) >> 13)))) | (14 * (1 & ((v381) >> 14))));
      v823 <- (((((((((((((((0 * (1 & ((v386) >> 0))) | (1 * (1 & ((v386) >> 1)))) | (2 * (1 & ((v386) >> 2)))) | (3 * (1 & ((v386) >> 3)))) | (4 * (1 & ((v386) >> 4)))) | (5 * (1 & ((v386) >> 5)))) | (6 * (1 & ((v386) >> 6)))) | (7 * (1 & ((v386) >> 7)))) | (8 * (1 & ((v386) >> 8)))) | (9 * (1 & ((v386) >> 9)))) | (10 * (1 & ((v386) >> 10)))) | (11 * (1 & ((v386) >> 11)))) | (12 * (1 & ((v386) >> 12)))) | (13 * (1 & ((v386) >> 13)))) | (14 * (1 & ((v386) >> 14))));
      v824 <- (((((((((((((((0 * (1 & ((v405) >> 0))) | (1 * (1 & ((v405) >> 1)))) | (2 * (1 & ((v405) >> 2)))) | (3 * (1 & ((v405) >> 3)))) | (4 * (1 & ((v405) >> 4)))) | (5 * (1 & ((v405) >> 5)))) | (6 * (1 & ((v405) >> 6)))) | (7 * (1 & ((v405) >> 7)))) | (8 * (1 & ((v405) >> 8)))) | (9 * (1 & ((v405) >> 9)))) | (10 * (1 & ((v405) >> 10)))) | (11 * (1 & ((v405) >> 11)))) | (12 * (1 & ((v405) >> 12)))) | (13 * (1 & ((v405) >> 13)))) | (14 * (1 & ((v405) >> 14))));
      v825 <- (((((((((((((((0 * (1 & ((v425) >> 0))) | (1 * (1 & ((v425) >> 1)))) | (2 * (1 & ((v425) >> 2)))) | (3 * (1 & ((v425) >> 3)))) | (4 * (1 & ((v425) >> 4)))) | (5 * (1 & ((v425) >> 5)))) | (6 * (1 & ((v425) >> 6)))) | (7 * (1 & ((v425) >> 7)))) | (8 * (1 & ((v425) >> 8)))) | (9 * (1 & ((v425) >> 9)))) | (10 * (1 & ((v425) >> 10)))) | (11 * (1 & ((v425) >> 11)))) | (12 * (1 & ((v425) >> 12)))) | (13 * (1 & ((v425) >> 13)))) | (14 * (1 & ((v425) >> 14))));
      v722 <- ((v428) | ((v719) ^ 1));
      v826 <- (((((((((((((((0 * (1 & ((v444) >> 0))) | (1 * (1 & ((v444) >> 1)))) | (2 * (1 & ((v444) >> 2)))) | (3 * (1 & ((v444) >> 3)))) | (4 * (1 & ((v444) >> 4)))) | (5 * (1 & ((v444) >> 5)))) | (6 * (1 & ((v444) >> 6)))) | (7 * (1 & ((v444) >> 7)))) | (8 * (1 & ((v444) >> 8)))) | (9 * (1 & ((v444) >> 9)))) | (10 * (1 & ((v444) >> 10)))) | (11 * (1 & ((v444) >> 11)))) | (12 * (1 & ((v444) >> 12)))) | (13 * (1 & ((v444) >> 13)))) | (14 * (1 & ((v444) >> 14))));
      dataflow_cluser {
        v481 <- (((v460) << 0) | ((v461) << 1));
        v494 <- (((v460) << 0) | ((v461) << 1));
        v860 <- ((0 * (v460)) | (1 * (v461)));
      ...
      v471 <- (1 ^ (v470));
      v474 <- (1 ^ (v473));
      v827 <- ((0 * (1 & ((v479) >> 0))) | (1 * (1 & ((v479) >> 1))));
      v828 <- ((0 * (1 & ((v485) >> 0))) | (1 * (1 & ((v485) >> 1))));
      v829 <- ((0 * (1 & ((v492) >> 0))) | (1 * (1 & ((v492) >> 1))));
      v830 <- ((0 * (1 & ((v498) >> 0))) | (1 * (1 & ((v498) >> 1))));
      dataflow_cluser {
        v522 <- (((v501) << 0) | ((v502) << 1));
        v535 <- (((v501) << 0) | ((v502) << 1));
        v861 <- ((0 * (v501)) | (1 * (v502)));
      ...
      v512 <- (1 ^ (v511));
      v515 <- (1 ^ (v514));
      v831 <- ((0 * (1 & ((v520) >> 0))) | (1 * (1 & ((v520) >> 1))));
      v832 <- ((0 * (1 & ((v526) >> 0))) | (1 * (1 & ((v526) >> 1))));
      v833 <- ((0 * (1 & ((v533) >> 0))) | (1 * (1 & ((v533) >> 1))));
      v834 <- ((0 * (1 & ((v539) >> 0))) | (1 * (1 & ((v539) >> 1))));
      dataflow_cluser {
        v562 <- (((v542) << 0) | ((v543) << 1));
        v575 <- (((v542) << 0) | ((v543) << 1));
        v862 <- ((0 * (v542)) | (1 * (v543)));
      ...
      v552 <- (1 ^ (v551));
      v555 <- (1 ^ (v554));
      v835 <- ((0 * (1 & ((v560) >> 0))) | (1 * (1 & ((v560) >> 1))));
      v836 <- ((0 * (1 & ((v566) >> 0))) | (1 * (1 & ((v566) >> 1))));
      v837 <- ((0 * (1 & ((v573) >> 0))) | (1 * (1 & ((v573) >> 1))));
      v838 <- ((0 * (1 & ((v579) >> 0))) | (1 * (1 & ((v579) >> 1))));
      v586 <- ((v584) | (v585));
      v590 <- ((v588) ^ 1);
      v595 <- ((v593) | (v594));
      v599 <- ((v597) ^ 1);
      ...
      v676 <- ((v674) | (v675));
      v680 <- ((v678) ^ 1);
      v839 <- ((0 * (1 & ((v727) >> 0))) | (1 * (1 & ((v727) >> 1))));
      v840 <- ((0 * (1 & ((v733) >> 0))) | (1 * (1 & ((v733) >> 1))));
      v841 <- ((0 * (1 & ((v738) >> 0))) | (1 * (1 & ((v738) >> 1))));
      v842 <- ((0 * (1 & ((v744) >> 0))) | (1 * (1 & ((v744) >> 1))));
      v843 <- ((0 * (1 & ((v749) >> 0))) | (1 * (1 & ((v749) >> 1))));
      v844 <- ((0 * (1 & ((v755) >> 0))) | (1 * (1 & ((v755) >> 1))));
      v845 <- ((0 * (1 & ((v760) >> 0))) | (1 * (1 & ((v760) >> 1))));
      v846 <- ((0 * (1 & ((v766) >> 0))) | (1 * (1 & ((v766) >> 1))));
      v847 <- ((0 * (1 & ((v773) >> 0))) | (1 * (1 & ((v773) >> 1))));
      v848 <- ((0 * (1 & ((v779) >> 0))) | (1 * (1 & ((v779) >> 1))));
      v849 <- ((0 * (1 & ((v786) >> 0))) | (1 * (1 & ((v786) >> 1))));
      v850 <- ((0 * (1 & ((v792) >> 0))) | (1 * (1 & ((v792) >> 1))));
      v851 <- ((0 * (1 & ((v799) >> 0))) | (1 * (1 & ((v799) >> 1))));
      v852 <- ((0 * (1 & ((v805) >> 0))) | (1 * (1 & ((v805) >> 1))));
      { v853 } v7 -> *, v10;
      { v853 } v0 -> *, v11;
      { v853 } v1 -> *, v12;
      { v853 } v2 -> *, v13;
      ...
      v52 -> [1,0] v51;
      v55 -> [1,0] v54;
      { v854 } v71, v72, v73, v74, v75, v76, v77, v78, v79, v80, v81, v82, v83, v84, v85 -> v24;
      { v855 } v26 -> *, v88;
      { v855 } v29 -> *, v89;
      { v855 } v90, v88 -> v91;
      { v855 } v97, v89 -> v30;
      ...
      { v616 } v591, v191 -> v609;
      v614 -> [1,0] v611;
      { v858 } v219, v220, v221, v222, v223, v224, v225, v226, v227, v228, v229, v230, v231, v232, v233 -> v38;
      { v859 } v22 -> *, v249, v250, v251, v252, v253, v254, v255, v256, v257, v258, v259, v260, v261, v262;
      { v859 } v30 -> *, *, *, v263, v264, v265, *, *, v266, v267, v268, v269, *, v270, v271;
      { v859 } v33 -> *, *, *, *, v272, v273, *, *, v274, v275, v276, *, *, *, v277;
      { v859 } v36 -> *, *, *, *, *, v278, *, *, *, *, *, *, *, *, *;
      { v859 } v40 -> v280, v281, *, *, *, *, v282, v283, *, *, *, v284, *, *, *;
      { v859 } v43 -> v285, v286, v287, *, *, *, v288, v289, v290, v291, v292, v293, v294, v295, v296;
      { v859 } v46 -> v297, v298, v299, v300, v301, *, v302, v303, v304, v305, v306, v307, v308, v309, v310;
      { v859 } v311, v249, v250, v251, v252, v253, v254, v255, v256, v257, v258, v259, v260, v261, v262 -> v19;
      { v859 } v280, v281, v323, v263, v264, v265, v282, v283, v313, v314, v315, v284, v331, v317, v318 -> v41;
      { v859 } v285, v286, v287, v263, v272, v278, v288, v289, v290, v291, v292, v293, v294, v295, v296 -> v44;
      { v859 } v297, v298, v299, v300, v301, v273, v302, v303, v304, v305, v306, v307, v308, v309, v310 -> v47;
      v322 -> [1,0] v321;
      v325 -> [1,0] v324;
      v330 -> [1,0] v329;
      v333 -> [1,0] v332;
      { v336 } v337 -> *, v339;
      { v336 } v340, v339 -> v338;
      { v819 } v342, v343, v324, v345, v346, v347, v348, v349, v350, v351, v352, v353, v354, v355, v356 -> v341;
      { v341 } v338 -> *, v357;
      { v820 } v334 -> *, *, v323, *, *, *, *, *, *, *, *, *, *, *, *;
      v341 -> [1,0] v336;
      v338 -> [1,1] v337;
      { v360 } v361 -> *, v363;
      { v360 } v364, v363 -> v362;
      { v821 } v366, v367, v368, v369, v370, v371, v372, v373, v374, v375, v376, v377, v332, v379, v380 -> v365;
      { v365 } v362 -> *, v381;
      { v822 } v358 -> *, *, *, *, *, *, *, *, *, *, *, *, v331, *, *;
      v365 -> [1,0] v360;
      v362 -> [1,1] v361;
      { v384 } v385 -> *, v387;
      { v384 } v388, v387 -> v386;
      { v823 } v390, v391, v321, v393, v394, v395, v396, v397, v398, v399, v400, v401, v402, v403, v404 -> v389;
      { v389 } v386 -> *, v405;
      { v824 } v406, v407, v320, v409, v410, v411, v412, v413, v414, v415, v416, v417, v418, v419, v420 -> v382;
      v389 -> [1,0] v384;
      v386 -> [1,1] v385;
      { v423 } v424 -> *, v426;
      { v423 } v427, v426 -> v425;
      { v825 } v429, v430, v431, v432, v433, v434, v435, v436, v437, v438, v439, v329, v441, v442, v443 -> v428;
      { v428 } v425 -> *, v444;
      { v826 } v445, v446, v447, v448, v449, v450, v451, v452, v453, v454, v455, v269, v457, v458, v459 -> v421;
      v428 -> [1,0] v423;
      v425 -> [1,1] v424;
      { v620 } v54, v341 -> v621;
      { v622 } v621 -> *, v619;
