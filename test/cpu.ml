...
let%expect_test "fibonacci" =
  ...
  [%expect
    {|
    defproc proc_0(chan!(int<8>) iport919; chan!(int<8>) iport929; chan!(int<8>) iport939; chan?(int<13>) oport949; chan?(int<8>) oport961; chan?(int<13>) oport973; chan?(int<8>) oport985) {
      chan(int<1>) v0;
      chan(int<2>) v1;
      chan(int<1>) v2;
      chan(int<1>) v3;
    ...
    dataflow {
     ...
     v14 -> [1,0] v15;
      v15 <- (1 ^ (v14));
      v16 <- (((((((((((((((int(0 = (v8)) << 0) | (int(1 = (v8)) << 1)) | (int(2 = (v8)) << 2)) | (int(3 = (v8)) << 3)) | (int(4 = (v8)) << 4)) | (int(5 = (v8)) << 5)) | (int(6 = (v8)) << 6)) | (int(7 = (v8)) << 7)) | (int(8 = (v8)) << 8)) | (int(9 = (v8)) << 9)) | (int(10 = (v8)) << 10)) | (int(11 = (v8)) << 11)) | (int(12 = (v8)) << 12)) | (int(13 = (v8)) << 13)) | (int(14 = (v8)) << 14));
      {v16} v7 -> *, v17, v18, v19, v20, v21, v22, v23, v24, v25, v26, v27, v28, v29, v30;
      {v16} v31, v17, v18, v19, v20, v21, v22, v23, v24, v25, v26, v27, v28, v29, v30 -> v4;
      v31 <- 1;
      v34 <- 2;
     v35 -> [1,0] v36;
      v36 <- (1 ^ (v35));
     ...
     v509 -> [1,0] v510;
      v510 <- (1 ^ (v509));
      v511 <- int(((int((v498), 8) | 256) + int((v490), 8)), 8);
     v512 -> [1,0] v513;
      v513 <- (1 ^ (v512));
      {v534} v524, v509 -> v535;
      v536 <- ((v534) | (v535));
     ...
     v631 -> [1,0] v634;
      {v640} v641 -> *, v643;
      {v640} v16, v643 -> v642;
      {v642} v645, v646, v38, v648, v649, v650, v651, v652, v653, v654, v655, v656, v657, v658, v659 -> v639;
      v645 <- 0;
      v646 <- 0;
      v648 <- 0;
      v649 <- 0;
     ...
     v641 -> [1,1] v642;
      {v663} v664 -> *, v666;
      {v663} v16, v666 -> v665;
      {v665} v668, v669, v670, v53, v127, v235, v312, v371, v413, v464, v515, v547, v680, v569, v612 -> v662;
      v668 <- 0;
      v669 <- 0;
      v670 <- 0;
      v680 <- 0;
      {v662} v665 -> *, v683;
      {v683} v661 -> *, *, *, v47, v126, v234, *, *, v412, v463, v514, v541, *, v563, v611;
     v663 -> [1,0] v662;
     v664 -> [1,1] v665;
      {v686} v687 -> *, v689;
      {v686} v16, v689 -> v688;
      {v688} v691, v692, v693, v694, v695, v696, v697, v698, v699, v700, v701, v702, v553, v704, v705 -> v685;
      v691 <- 0;
      v692 <- 0;
      v693 <- 0;
      v694 <- 0;
     ...
     v687 -> [1,1] v688;
      {v709} v710 -> *, v712;
      {v709} v16, v712 -> v711;
      {v711} v714, v715, v35, v717, v718, v719, v720, v721, v722, v723, v724, v725, v726, v727, v728 -> v708;
      v714 <- 0;
      v715 <- 0;
      v717 <- 0;
      v718 <- 0;
      ...
      v728 <- 0;
      {v708} v711 -> *, v729;
      {v729} v730, v731, v34, v733, v734, v735, v736, v737, v738, v739, v740, v741, v742, v743, v744 -> v707;
      v730 <- 0;
      v731 <- 0;
      v733 <- 0;
      v734 <- 0;
     ...
     v710 -> [1,1] v711;
      {v747} v748 -> *, v750;
      {v747} v16, v750 -> v749;
      {v749} v752, v753, v45, v79, v154, v280, v758, v759, v410, v461, v512, v763, v561, v576, v609 -> v746;
      v752 <- 0;
      v753 <- 0;
      v758 <- 0;
      v759 <- 0;
      v763 <- 0;
      {v746} v749 -> *, v767;
      {v767} v768, v769, v32, v78, v153, v279, v774, v775, v409, v460, v511, v779, v552, v575, v608 -> v745;
      v768 <- 0;
      v769 <- 0;
      v774 <- 0;
      v775 <- 0;
     ...
     v748 -> [1,1] v749;
      {v785} v786 -> *, v788;
      {v785} v16, v788 -> v787;
      {v787} v790, v791, v42, v88, v163, v289, v321, v380, v431, v482, v533, v544, v558, v579, v630 -> v784;
      v790 <- 0;
      v791 <- 0;
      {v784} v787 -> *, v805;
      {v805} v806, v807, v41, v87, v162, v288, v320, v379, v430, v481, v532, v543, v557, v578, v629 -> v783;
      v806 <- 0;
      v807 <- 0;
     v785 -> [1,0] v784;
     v786 -> [1,1] v787;
      {v823} v824 -> *, v826;
      {v823} v16, v826 -> v825;
      {v825} v828, v829, v830, v831, v832, v833, v834, v835, v836, v837, v838, v550, v840, v841, v842 -> v822;
      v828 <- 0;
      v829 <- 0;
      v830 <- 0;
      v831 <- 0;
      ...
      v842 <- 0;
      {v822} v825 -> *, v843;
      {v843} v844, v845, v846, v847, v848, v849, v850, v851, v852, v853, v854, v541, v856, v857, v858 -> v821;
      v844 <- 0;
      v845 <- 0;
      v846 <- 0;
      v847 <- 0;
