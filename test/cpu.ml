...
let%expect_test "fibonacci" =
  ...
  [%expect
    ...
    defproc proc_0(chan!(int<8>) iport21; chan!(int<8>) iport519; chan!(int<8>) iport313; chan?(int<13>) oport18; chan?(int<8>) oport564; chan?(int<13>) oport573; chan?(int<8>) oport338) {
      chan(int<12>) v0;
      chan(int<1>) v1;
      chan(int<1>) v2;
      chan(int<1>) v3;
    ...
    dataflow {
      ...
      v610 <- ( log2_one_hot({ int((v41), 1), int((v40), 1), int((v39), 1), int((v38), 1), int((v37), 1), int((v36), 1), int((v35), 1), int((v34), 1), int((v33), 1), int((v32), 1), int((v31), 1), int((v30), 1), int((v29), 1), int((v28), 1), int((v27), 1), int((v26), 1) }) );
      dataflow_cluser {
        v59 <- int((v58) >= 1);
        v60 <- int(int((v58) >= 1) = 0);
        v98 <- int((v58) >= 2);
        v99 <- int(int((v58) >= 2) = 0);
        v139 <- int((v58) >= 3);
        v140 <- int(int((v58) >= 3) = 0);
      };
      dataflow_cluser {
        v80 <- { int((v60), 1), int((v59), 1) };
        v91 <- { int((v60), 1), int((v59), 1) };
        v611 <- ( log2_one_hot({ int((v60), 1), int((v59), 1) }) );
      };
      v70 <- (1 ^ (v69));
      v73 <- (1 ^ (v72));
      v582 <- ( log2_one_hot((v78)) );
      v583 <- ( log2_one_hot((v84)) );
      v584 <- ( log2_one_hot((v89)) );
      v585 <- ( log2_one_hot((v95)) );
      dataflow_cluser {
        v121 <- { int((v99), 1), int((v98), 1) };
        v132 <- { int((v99), 1), int((v98), 1) };
        v612 <- ( log2_one_hot({ int((v99), 1), int((v98), 1) }) );
      };
      v105 <- ((v101) + 1);
      v109 <- ((v105) << 1);
      v111 <- (1 ^ (v110));
      v114 <- (1 ^ (v113));
      v586 <- ( log2_one_hot((v119)) );
      v587 <- ( log2_one_hot((v125)) );
      v588 <- ( log2_one_hot((v130)) );
      v589 <- ( log2_one_hot((v136)) );
      dataflow_cluser {
        v162 <- { int((v140), 1), int((v139), 1) };
        v173 <- { int((v140), 1), int((v139), 1) };
        v613 <- ( log2_one_hot({ int((v140), 1), int((v139), 1) }) );
      };
      v146 <- ((v142) + 1);
      v150 <- ((v146) << 1);
      v152 <- (1 ^ (v151));
      v155 <- (1 ^ (v154));
      v590 <- ( log2_one_hot((v160)) );
      v591 <- ( log2_one_hot((v166)) );
      v592 <- ( log2_one_hot((v171)) );
      v593 <- ( log2_one_hot((v177)) );
      v614 <- ( log2_one_hot({ int((v195), 1), int((v194), 1), int((v193), 1), int((v192), 1), int((v191), 1), int((v190), 1), int((v189), 1), int((v188), 1), int((v187), 1), int((v186), 1), int((v185), 1), int((v184), 1), int((v183), 1), int((v182), 1), int((v181), 1), int((v180), 1) }) );
      dataflow_cluser {
        v379 <- int((v212) >= 1);
        v380 <- int(int((v212) >= 1) = 0);
        v420 <- int((v212) >= 2);
        v421 <- int(int((v212) >= 2) = 0);
        v461 <- int((v212) >= 3);
        v462 <- int(int((v212) >= 3) = 0);
      };
      dataflow_cluser {
        v319 <- { int((v228), 1), int((v227), 1), int((v226), 1), int((v225), 1), int((v224), 1), int((v223), 1), int((v222), 1), int((v221), 1), int((v220), 1), int((v219), 1), int((v218), 1), int((v217), 1), int((v216), 1), int((v215), 1), int((v214), 1), int((v213), 1) };
        v344 <- { int((v228), 1), int((v227), 1), int((v226), 1), int((v225), 1), int((v224), 1), int((v223), 1), int((v222), 1), int((v221), 1), int((v220), 1), int((v219), 1), int((v218), 1), int((v217), 1), int((v216), 1), int((v215), 1), int((v214), 1), int((v213), 1) };
        v615 <- ( log2_one_hot({ int((v228), 1), int((v227), 1), int((v226), 1), int((v225), 1), int((v224), 1), int((v223), 1), int((v222), 1), int((v221), 1), int((v220), 1), int((v219), 1), int((v218), 1), int((v217), 1), int((v216), 1), int((v215), 1), int((v214), 1), int((v213), 1) }) );
      };
      v297 <- ((v295) | int((int((v244), 4) << 4), 8));
      v298 <- int((v248) = (v256));
      v299 <- int(((v249) + (v257)), 8);
      v300 <- int(((int((v258), 8) | 256) + int((v250), 8)), 8);
      v302 <- int(0 = (v252));
      v303 <- (int(0 != (v253)) | int(0 != (v259)));
      v309 <- (1 ^ (v308));
      v312 <- (1 ^ (v311));
      v594 <- ( log2_one_hot((v317)) );
      v595 <- ( log2_one_hot((v337)) );
      v596 <- ( log2_one_hot((v342)) );
      v597 <- ( log2_one_hot((v362)) );
      dataflow_cluser {
        v400 <- { int((v380), 1), int((v379), 1) };
        v413 <- { int((v380), 1), int((v379), 1) };
        v616 <- ( log2_one_hot({ int((v380), 1), int((v379), 1) }) );
      };
      dataflow_cluser {
        v388 <- { int((v382), 12), int(1, 1) };
        v384 <- (1 + (v382));
      };
      v390 <- (1 ^ (v389));
      v393 <- (1 ^ (v392));
      v598 <- ( log2_one_hot((v398)) );
      v599 <- ( log2_one_hot((v404)) );
      v600 <- ( log2_one_hot((v411)) );
      v601 <- ( log2_one_hot((v417)) );
      dataflow_cluser {
        v441 <- { int((v421), 1), int((v420), 1) };
        v454 <- { int((v421), 1), int((v420), 1) };
        v617 <- ( log2_one_hot({ int((v421), 1), int((v420), 1) }) );
      };
      dataflow_cluser {
        v429 <- { int((v423), 12), int(1, 1) };
        v425 <- (1 + (v423));
      };
      v431 <- (1 ^ (v430));
      v434 <- (1 ^ (v433));
      v602 <- ( log2_one_hot((v439)) );
      v603 <- ( log2_one_hot((v445)) );
      v604 <- ( log2_one_hot((v452)) );
      v605 <- ( log2_one_hot((v458)) );
      dataflow_cluser {
        v481 <- { int((v462), 1), int((v461), 1) };
        v494 <- { int((v462), 1), int((v461), 1) };
        v618 <- ( log2_one_hot({ int((v462), 1), int((v461), 1) }) );
      };
      dataflow_cluser {
        v469 <- { int((v464), 12), int(1, 1) };
        v466 <- (1 + (v464));
      };
      v471 <- (1 ^ (v470));
      v474 <- (1 ^ (v473));
      v606 <- ( log2_one_hot((v479)) );
      v607 <- ( log2_one_hot((v485)) );
      v608 <- ( log2_one_hot((v492)) );
      v609 <- ( log2_one_hot((v498)) );
      v505 <- ((v503) | (v504));
      v509 <- ((v507) ^ 1);
      v514 <- ((v512) | (v513));
      v518 <- ((v516) ^ 1);
      ...
      { v2 } v9 -> *, v7;
      v2 -> [1,0] v4;
      { v610 } v42, v43, v44, v45, v46, v47, v48, v49, v50, v51, v52, v53, v54, v55, v56, v57 -> v58;
      { v611 } v10 -> *, v61;
      { v611 } v8 -> *, v62;
      { v611 } v71, v61 -> v64;
      { v611 } v65, v62 -> v66;
      ...
      { v535 } v510, v167 -> v528;
      v533 -> [1,0] v530;
      { v614 } v196, v197, v198, v199, v200, v201, v202, v203, v204, v205, v206, v207, v208, v209, v210, v211 -> v212;
      { v615 } v6 -> *, v229, v230, v231, v232, v233, v234, v235, v236, v237, v238, v239, v240, v241, v242, v243;
      { v615 } v64 -> *, *, *, v244, v245, v246, v247, *, *, v248, v249, v250, v251, *, v252, v253;
      { v615 } v104 -> *, *, *, *, *, v254, v255, *, *, v256, v257, v258, *, *, *, v259;
      { v615 } v145 -> *, *, *, *, *, *, v260, *, *, *, *, *, *, *, *, *;
      { v615 } v13 -> v261, v262, *, *, *, *, *, v263, v264, *, *, *, v265, *, *, *;
      { v615 } v14 -> v266, v267, v268, v269, *, *, *, v270, v271, v272, v273, v274, v275, v276, v277, v278;
      { v615 } v15 -> v279, v280, v281, v282, v283, v284, *, v285, v286, v287, v288, v289, v290, v291, v292, v293;
      { v615 } v25 -> *, *, v294, v295, *, *, *, *, *, *, *, *, *, *, *, *;
      { v615 } v296, v229, v230, v231, v232, v233, v234, v235, v236, v237, v238, v239, v240, v241, v242, v243 -> v3;
      { v615 } v261, v262, v294, v297, v245, v246, v247, v263, v264, v298, v299, v300, v265, v310, v302, v303 -> v304;
      { v615 } v266, v267, v268, v269, v245, v254, v260, v270, v271, v272, v273, v274, v275, v276, v277, v278 -> v305;
      { v615 } v279, v280, v281, v282, v283, v284, v255, v285, v286, v287, v288, v289, v290, v291, v292, v293 -> v306;
      v309 -> [1,0] v308;
      v312 -> [1,0] v311;
      { v315 } v316 -> *, v318;
      { v315 } v319, v318 -> v317;
      { v594 } v321, v322, v323, v324, v325, v326, v327, v328, v329, v330, v331, v332, v333, v311, v335, v336 -> v320;
      { v320 } v317 -> *, v337;
      { v595 } v313 -> *, *, *, *, *, *, *, *, *, *, *, *, *, v310, *, *;
      v320 -> [1,0] v315;
      v317 -> [1,1] v316;
      { v340 } v341 -> *, v343;
      { v340 } v344, v343 -> v342;
      { v596 } v346, v347, v348, v349, v350, v351, v352, v353, v354, v355, v356, v357, v308, v359, v360, v361 -> v345;
      { v345 } v342 -> *, v362;
      { v597 } v363, v364, v365, v366, v367, v368, v369, v370, v371, v372, v373, v374, v251, v376, v377, v378 -> v338;
      v345 -> [1,0] v340;
      v342 -> [1,1] v341;
      { v616 } v304 -> v381, *;
      { v616 } v147 -> v382, v383;
