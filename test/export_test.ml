...
let%expect_test "test2" =
  ...
  [%expect
    ...
    defproc proc_0() {
      ...
      int<32> v1;
    chp {
    (v0 := 123456); (v1 := 1); ([bool(int(int((v0) != 1) = 0)) ->  [true]  [] bool(int((v0) != 1)) ->  *[ (v1 := (1 + (v1))); ([bool(int(0 = ((v0) % 2))) -> v0 := ((v0) / 2) [] bool(int(int(0 = ((v0) % 2)) = 0)) -> v0 := (1 + (3 * (v0)))]) <- bool(int((v0) != 1)) ] ])
    }
    }
...
let%expect_test "mini cpu" =
  ...
  [%expect
    ...
    defproc proc_0(chan!(int<2>) C0; chan!(int<8>) C1; chan!(int<8>) C2; chan?(int<8>) C3) {
      ...
      int<8> v2;
    chp {
    (v0 := 0); (v1 := 0); (v2 := 0); ( *[ (C0?v0); ([bool(int(0 = (v0))) -> ((C1?v1), (C2?v2)); (C3!((((v1) + (v2)) & 255))) [] bool(int(1 = (v0))) -> ((C1?v1), (C2?v2)); (C3!((((v1) * (v2)) & 255))) [] bool(int(2 = (v0))) -> ((C1?v1), (C2?v2)); (C3!(((v1) & (v2)))) [] bool(int(3 = (v0))) -> ((C1?v1), (C2?v2)); (C3!(((v1) | (v2))))]) <- bool(1) ] )
    }
    }
